...
```mermaid
graph TD
    A[Gaddafi's Offensive on Benghazi] --> B[UNSC Res 1973 & NATO Intervention]
    B --> C[Establishment of No-Fly Zone]
    B --> D[Naval Blockade & Arms Embargo]
    C --> E[Degradation of Regime Air Power]
    D --> F[Limiting Regime Resupply]
    E & F --> G[Stalemate & Urban Siege in Misrata]
    G --> H[Rebel Consolidation in Nafusa Mountains]
    H --> I[Operation Mermaid Dawn: Fall of Tripoli]
```
