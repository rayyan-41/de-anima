...
# BIO - Ibn Sina (Avicenna): The Prince of Physicians and the Peak of Logic
...
```mermaid
graph TD
    A[Subject Created in a Void] --> B[No Sensory Input: No Sight, No Sound, No Touch]
    B --> C[No Awareness of Limbs: Limbs are Splayed, Not Touching]
    C --> D[Total Physical Disconnection]
    D --> E{Does the Subject Exist?}
    E -->|Yes| F[The Subject Affirms: 'I Am']
    F --> G[Self-Awareness is Immediate and Non-Sensory]
    G --> H[The 'I' is an Immaterial Substance - The Soul]
    H --> I[Conclusion: Soul is Distinct from the Body]
```
