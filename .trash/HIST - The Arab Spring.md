...
```mermaid
graph TD
    A[Structural Pressures: Youth Bulge, Crony Capitalism] --> B[Relative Deprivation: The Gap between Expectations and Reality]
    B --> C{The Catalyst: Mohamed Bouazizi Dec 2010}
    C --> D[Shattering the Barrier of Fear: The Tunisian Spark]
    D --> E[Regional Contagion: Digital & Satellite Amplification]
    E --> F[Mass Mobilization: Tahrir, Pearl Roundabout, Benghazi]
    F --> G{The Institutional Pivot: Military Decision}
    G --> H[Military Defection/Neutrality: Regime Collapse - Tunisia, Egypt]
    G --> I[Military Loyalty/Fragmentation: Civil War - Libya, Syria, Yemen]
    H --> J[Democratic Opening / Arab Winter Restoration]
    I --> K[Proxy War & State Failure]
```
