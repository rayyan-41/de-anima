...
chunks = [
    {
        "file": "E:/De Anima/_tmp/transformer-vs-diffusion_chunk_01.md",
        "content": r"""## 1. The Core Problem: Why Did AI Need a Paradigm Shift?
...
"""
    ...
    {
        "file": "E:/De Anima/_tmp/transformer-vs-diffusion_chunk_02.md",
        "content": r"""## 2. Intuitive Foundation: From Sequential Reading to Global Attention
...
"""
    ...
    {
        "file": "E:/De Anima/_tmp/transformer-vs-diffusion_chunk_03.md",
        "content": r"""## 3. The Mechanics of Transformers: Self-Attention and Parallel Processing
...
"""
    ...
    {
        "file": "E:/De Anima/_tmp/transformer-vs-diffusion_chunk_04.md",
        "content": r"""## 4. Scaling Down: The Rise of Small Language Models (SLMs) vs LLMs
...
"""
    ...
    {
        "file": "E:/De Anima/_tmp/transformer-vs-diffusion_chunk_05.md",
        "content": r"""## 5. The Intuition of Diffusion: Reversing the Arrow of Entropy
...
"""
    ...
    {
        "file": "E:/De Anima/_tmp/transformer-vs-diffusion_chunk_06.md",
        "content": r"""## 6. Formalizing Diffusion: U-Nets, Markov Chains, and Denoising
...
By combining the U-Net with Text-to-Image capabilities—often using a *Transformer text encoder* (like CLIP) to process the user's prompt and forcefully inject it into the U-Net via cross-attention layers—we give the Diffusion model a steering wheel. It doesn't just denoise randomly into any valid image; it denoises aggressively *towards* the semantic mathematical vector provided by the text.
"""
    },
    {
        "file": "E:/De Anima/_tmp/transformer-vs-diffusion_chunk_07.md",
        "content": r"""## 7. Agentic AI: The Convergence of Reasoning (Transformers) and Perception (Diffusion)
...
"""
    ...
    {
        "file": "E:/De Anima/_tmp/transformer-vs-diffusion_chunk_08.md",
        "content": r"""## 8. Real-World Applications and Historical Context: The Path Forward
...
print("Successfully wrote 8 chunks.")
