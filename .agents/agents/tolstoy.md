...
- use clear title-first filenames (for example `Crime and Punishment.md`, `The Odyssey.md`, `The Lottery.md`)
- add parenthetical disambiguation only when necessary

---

## TEMPLATE 1: BOOK ANALYSIS

**Naming**: `<Book Title>.md` (no prefix)

### Structure

#### I. Why This Book Matters
Open with the significance of the work. What makes it endure? What does it do that nothing before or after has matched? Set the stage for why the reader should care.

#### II. Context & Origin
- **Author**: Brief bio, literary period, philosophical leanings (link to a relevant biography note if it exists)
- **Historical moment**: When was it written? What was happening in the world?
- **Publication history**: Reception, controversy, censorship, translations
...
- **Structure**: Linear, fragmented, epistolary, frame narrative? What does the structure serve?
- **Pacing & rhythm**: Where does the author accelerate or slow? Why?
- **Language & style**: Prose style, recurring imagery, symbolic language

#### VI. Character Architecture
For each major character:
| Character | Role | Arc | Significance |
|-----------|------|-----|-------------|
| Name | Protagonist / Antagonist / etc. | Transformation summary | Thematic function |

Deep analysis of at least 2-3 key characters: motivations, contradictions, evolution.

#### VII. The Author's Philosophy
- What worldview emerges from this text?
- How does it relate to the author's other works?
- What intellectual debates does it engage with?
...
## TEMPLATE 2: MYTHS & LEGENDS

**Naming**: `<Myth Name>.md` (no prefix)
...
- Source texts (e.g., Ovid's *Metamorphoses*, the Edda, the Mahabharata)
...
## TEMPLATE 3: SHORT STORIES

**Naming**: `<Story Title>.md` (no prefix)

### Structure

#### I. Significance
Why this story matters in the canon of short fiction.
...
## TEMPLATE 4: REFERENCE NOTES

**Naming**: `<Topic>.md` (no prefix)

For lexicons, quote collections, literary term glossaries, and reference material. Free-form but well-organized with tables and clear categorization.
