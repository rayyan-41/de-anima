...
- use clean topic-first filenames (for example `Tawassul (Aqeedah).md`, `Rafa al-Yadayn (Fiqh).md`)
- when topics overlap across Aqeedah and Fiqh, disambiguate with parentheses in the filename
...
## TEMPLATE 1: AQEEDAH NOTES

**Naming**: `<Topic>.md` (no prefix; use `(Aqeedah)` qualifier when needed)

### Structure

#### I. The Central Question
Open with the precise theological question this topic answers. State the stakes: why does this matter for faith and practice? Avoid preamble.

#### II. Quranic Foundation
- Present all directly relevant Ayat with:
  - Arabic text
  - English translation (clear, not archaic)
  - Brief tafsir note identifying which classical tafsir validates this reading
- Do not cherry-pick. Present the full range of relevant Ayat.

#### III. Hadith Evidence
- Relevant ahadith with:
...
- What did the earliest scholars (Salaf) conclude?
- Is there agreement (*ijma*) or legitimate disagreement (*ikhtilaf*)?
- Cite Imam Ahmad, Al-Shafi'i, Malik, Abu Hanifa, Ibn Taymiyyah, Al-Ghazali, Ibn Kathir, etc.

#### V. Theological Schools: Points of Contention
Present each school's position clearly:

| School | Position | Key Argument | Primary Proponent |
|--------|----------|--------------|-------------------|
| **Ash'ari** | ... | ... | Al-Ash'ari, Al-Ghazali, Al-Nawawi |
| **Maturidi** | ... | ... | Al-Maturidi, Abu Mansur |
| **Athari (Salafi)** | ... | ... | Ibn Taymiyyah, Ibn al-Qayyim |
...
- Dr. Israr Ahmad
- Dr. Zakir Naik (where relevant)
- Sheikh Hamza Yusuf
- Mufti Menk
- Dr. Yasir Qadhi
- Other top contemporary scholars relevant to the topic

#### VIII. Common Misconceptions & Bid'ah Watch
- What cultural practices exist around this topic that have no evidential basis?
- What are the common misunderstandings, especially in South Asian Islamic culture?
- What does the evidence actually say vs. what people assume?

---

## TEMPLATE 2: FIQH NOTES

**Naming**: `<Topic>.md` (no prefix; use `(Fiqh)` qualifier when needed)

> **Fiqh notes are the most exhaustive notes in the vault.** A question about a single act of worship may require 8,000+ words to do justice to the complexity. Do not summarize. Document completely.
...
##### A. Quranic Evidence
All Ayat directly or indirectly relevant. Include:
- Arabic text
- English translation
...
#### IV. Points of Agreement Across Schools
Present what ALL four schools agree on. This helps identify firm, unambiguous rulings vs. areas of legitimate scholarly diversity.
...
| Issue | Hanafi | Maliki | Shafi'i | Hanbali | Root Cause of Disagreement |
|-------|--------|--------|---------|---------|---------------------------|
| ... | ... | ... | ... | ... | Hadith authenticity dispute / Interpretation / Usul difference |

For each point of contention:
- State the exact disagreement
- Explain the **underlying reason** (not the conclusion, but the jurisprudential methodology that causes the split)
...
> *What has Pakistani/South Asian culture added or removed that has no basis in the Quran, Sunnah, or any of the four schools?*

- List specific cultural practices around this topic
- For each: Is it from a madhab? Is it a cultural invention? Is it bid'ah hasanah (good innovation tolerated by scholars) or bid'ah sayyiah (rejected innovation)?
- Cite specific scholars who have addressed these cultural distortions
- The goal is **not to attack culture** but to distinguish *deen* from *culture*

#### IX. Practical Conclusions & Guidance
After the full legal analysis:
...
- **Madhab balance**: Present all four schools with equal depth and fairness. No bias toward any school.
- **Hadith integrity**: Always state the grade of a hadith. Never present a weak hadith as authoritative without flagging it.
- **Anti-cultural-Islam**: Distinguish between Islamic ruling and South Asian/Pakistani cultural practice. This is a core feature of every Fiqh note.
- **Plain English**: Scholarly but accessible. Define Arabic terms when first used.
- **Arabic terms**: Use Arabic followed by a brief English definition in parentheses. E.g., *Rafa' al-Yadayn* (raising the hands in prayer).
- **Temperature 0.3**: Be precise. Minimize speculation. Stick to documented positions.
